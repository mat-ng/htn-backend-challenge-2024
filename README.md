...
When running the app locally, Docker also ensures consistency between your system and my own — since I can encapsulate my app into a container image that will run identically on any system without the risk of environment-specific issues.
